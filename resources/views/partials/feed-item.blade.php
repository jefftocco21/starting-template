      <li class="flex items-start gap-4 not-first:pt-2.5">
        <a href="/profile" class="shrink-0">
          <img src="{{$item->profile->displayName}}" alt="Avatar for Michael" class="size-10 object-cover" />
        </a>
          ...
          <div class="border-pixl-light/10 border-b pb-5">
            ...
            <div class="flex items-center justify-between gap-4">
              <div class="flex items-center gap-2.5">
                ...
                <p>
                  <a class="text-pixl-light/40 hover:text-pixl-light/60 text-xs" href="/profile">{{$item->profile->handle}}</a>
                </p>
              </div>
